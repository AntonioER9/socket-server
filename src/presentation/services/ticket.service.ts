...
export class TicketService {
  ...
  public get lastWorkingOnTickets(): Ticket[] { //siempre mostraremos 4 tickets
  ...
  public drawTicket(desk: string) {
    ...
    const ticket = this.tickets.find(t => !t.handleAtDesk); //vamos a buscar el primero que este en nulo
    ...
    //?WS
    this.workingOnTickets.unshift({ ...ticket }); //colocamos al principio del arreglo
